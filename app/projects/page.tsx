  ...
  return (
    <div className="min-h-screen bg-[#1a1625] text-[#e5e5e5] pt-16">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 style={{ fontFamily: "var(--font-space-grotesk)" }} className="text-6xl font-bold text-[#e5e5e5] mb-20 tracking-wide">
          Projects
        </h1>

        {/* Visual & Narrative Section */}
        <section className="mb-20">
          <h2 style={{ fontFamily: "var(--font-space-grotesk)" }} className="text-4xl font-bold text-[#e5e5e5] mb-10">
            Visual & Narrative
          </h2>
